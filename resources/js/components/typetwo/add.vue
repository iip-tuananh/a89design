      ...
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-5"><h4 class="card-title">Thêm mới phân loại cấp 2</h4></div>
...
components: {
  ...
  methods: {
    ...
    saveEdit() {
      ...
      if(this.objData.type_id == 0) this.errors.push('Phân loại 1 không được để trống');
      if (this.errors.length > 0) {
        ...
        .then(response => {
            ...
            this.$success("Thêm loại danh mục thành công");
            this.$route.push({ name: "list_type_two" });
          })
          .catch(error => {
            this.loadings(false);
            this.$error('Sửa loại danh mục thất bại');
          });
      }
    },
    findCategoryType() {
